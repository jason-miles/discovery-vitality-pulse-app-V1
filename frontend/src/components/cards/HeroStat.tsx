...
export function HeroStat({
  value, label, prefix = "", suffix = "", decimals = 0, space = false,
}: {
  value: number; label: string; prefix?: string; suffix?: string; decimals?: number; space?: boolean;
}) {
  ...
  return (
    <div className="rounded-xl border border-white/15 bg-white/5 px-5 py-4 text-center">
      <div className="tnum font-display text-4xl font-bold">{prefix}{grouped}{suffix}</div>
